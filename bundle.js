    ...
    div.innerHTML = `
      <div class="grid grid-cols-2 bg-gray-50 hover:bg-gray-100 p-4 cursor-pointer rounded-md border border-gray-300 transition-colors duration-300">
          ...
          <div class="p-1 bg-white rounded-lg font-mono">
            ...
            <input id="${
              "grosswgt_" + id
            }" type="number" class="bg-gray-50 hover:bg-gray-100 text-sm custom-input w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm transition duration-300 ease-in-out transform focus:-translate-y-1 focus:outline-blue-300 hover:shadow-lg hover:border-blue-300 " placeholder="Enter text here" type="text" />
          </div>
          <div class="p-1 bg-white rounded-lg font-mono">
            <label class="block text-gray-700 text-sm font-bold mb-2">Less</label>
            <input id="${
              "less_" + id
            }" value=0 type="number" class="bg-gray-50 hover:bg-gray-100 text-sm custom-input w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm transition duration-300 ease-in-out transform focus:-translate-y-1 focus:outline-blue-300 hover:shadow-lg hover:border-blue-300 " placeholder="Enter text here" type="text" />
          </div>
          <div class="p-1 bg-white rounded-lg font-mono">
